...
public class SearchOrderHistoryController extends HttpServlet {
    private static final Logger LOGGER = Logger.getLogger(SearchOrderHistoryController.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<OrderHistoryDTO> result = dao.getOrderHistory(search, from, to);
            request.setAttribute("INFO", result);
        } catch (Exception e) {
            LOGGER.error("ERROR at SearchOrderHistoryController: " + e.getMessage());
        } finally {
