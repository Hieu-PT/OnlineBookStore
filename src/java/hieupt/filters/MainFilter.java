...
public class MainFilter implements Filter {
    ...
    private static final String INDEX = "LoadCategoryController";
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        String url = INDEX;
        try{
            if(uri.contains("/img/") || uri.contains("/css/")){
                chain.doFilter(request, response);
            }
            else{
                int lastIndex = uri.lastIndexOf("/");
                String resource = uri.substring(lastIndex + 1);
                if (resource.equals("UpdateBookController") || resource.equals("CreateBookController")) {
                    url = resource;
            ...
            LOGGER.error("Error at MainFilter: " + e.getMessage());
        }
    }
